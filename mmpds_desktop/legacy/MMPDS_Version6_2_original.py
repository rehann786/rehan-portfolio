...
# -----------------------------------------------------------------------------
# Inlined performance engine: standalone main file, no external performance.py
# required. This keeps Advanced Selection / Material Finder filtering cached and
# avoids an extra helper-file dependency when running or building the EXE.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# FINAL ACTUAL 19K FILE PATCH: Done button + single Material Name + Notes layout
# -----------------------------------------------------------------------------
# REHAN_ACTUAL_19K_DONE_NAME_NOTES_ID_SORT_FIX_2026_06_23
# Scope: This patch intentionally keeps the existing application intact and only
# overrides the small behaviors discussed after the 19k-line file was uploaded.
# Changes covered:
# - one Material Name field beside Material Model on the Material Card
# - Notes under Material Summary for every material
# - Done saves/reopens/updates the same Advanced Export List row
# - ID/MID saves from the Material Card and sorting is numeric
# - removing rows renumbers IDs continuously from 1000
# - Advanced Export List only allows Unit direct-editing
# - custom/edited rows require Notes and use CUSTOM_ naming

import re as _rehan_re
